...
class EncoderBlock(nn.Module):
    def __init__(self, seq_len:int, batch:int, d_model:int, head:int, d_ff:int) -> None:
...
class Encoder(nn.Module):
    def __init__(self, number_of_block:int, seq_len:int, batch:int, d_model:int, head:int, d_ff:int) -> None:
